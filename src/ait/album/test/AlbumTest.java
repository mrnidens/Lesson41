...
class AlbumTest {
    ...
    void addPhoto() {
        ...
        photo = new Photo(2,6,"title6", "url6", now.minusDays(4));
    ...
    void removePhoto() {
        ...
        assertNull(album.removePhoto(1,1));
        assertEquals(5, album.size());
    }

    @org.junit.jupiter.api.Test
    void updatePhoto() {
        assertFalse(album.updatePhoto(5,5,"url10"));
        assertTrue(album.updatePhoto(1,1,"url10"));
        assertEquals("url10", album.getPhotoFromAlbum(1,1).getUrl());
    }
